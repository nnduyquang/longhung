<div class="sidebar closed">
    ...
    <ul>
        ...
        {{--<li><a href="{{URL::to('category')}}"><i class="fa fa-list icon-sidebar" aria-hidden="true"></i>Thông Tin Dự Án</a></li>--}}
    ...
    <div class="sidebar-hotline">HOTLINE: <a href="tel:0909345117"><span class="sidebar-number">0909.345.117</span></a></div>
</div>